...
<body>
    ...
    <form action="../controllers/displaySelectedRoundTripFlight.php" method="post">
        <div class="form-row">
          <div class="col-md-4 mb-3">
            ...
            <select class="form-control" name="tipo_vuelo" onchange="location = this.value;">
              <option value="Vuelo ida y vuelta">Vuelo ida y vuelta</option>
              <option value="../index.php">Vuelo sencillo</option>
            </select>
          </div>
          <div class="col-md-4 mb-3">
        ...
        <div class="form-row">
          ...
          <div class="col-md-4 mb-3">
            <label for="validationDefault01">Fecha de vuelta</label>
            <input type="date" class="form-control" id="validationDefault01" name=fecha_vuelta>
          </div>
